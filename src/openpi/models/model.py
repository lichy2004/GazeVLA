...
class Observation(Generic[ArrayT]):
    ...
    # gaze, [h, w]
    gaze: at.Int[ArrayT, "*b gd"] | None = None

    # action_mask: int, shape [*b T d] where d can be 1 (RobotWin) or 2 (Human)
    action_mask: at.Int[ArrayT, "*b T d"] | None = None
    # gaze_mask: int
    gaze_mask: at.Int[ArrayT, "*b 1"] | None = None
